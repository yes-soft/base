angular.module('schemaForm').config(['schemaFormDecoratorsProvider', function (decoratorsProvider) {
    ...
    decoratorsProvider.defineDecorator('bootstrapDecorator', {
        ...
        group: {template: base + 'group.html', replace: false},
        list: {template: base + 'list.html', replace: false},
        ...
        datepicker: {template: base + 'datepicker.html', replace: false},
        datetimepicker: {template: base + 'datetimepicker.html', replace: false},
