                ...
                list: {
                    ...
                    headers: {
                        ...
                        operations: {
                            displayName: '操作',
                            cellTemplate: "<div>" +
                            "<a href='' ng-click=\"grid.appScope.customClick($event,'submitOrder',row.entity)\"> {{row.entity.active | translatePrefix:'active' }}</a>" +
                            " <a ng-show='row.entity.active'>高级操作</a>" +
                            "</div>"
                        }
                    },
                    filters: [
                    ...
                    resolves: function (utils, oPath, $timeout) {
                        ...
                        context.scope.submitOrder = function (row) {
                            utils.async('put', "demo/examples/" + row.uid, {'active': !row.active}).then(function (res) {
                                context.scope.load();
                            });
                        };
                    }
                                ...
                                dialog.open(
                                    {
                                        ...
                                        controller: function ($scope) {
                                            $scope.save = function () {
                                                utils.async('post', 'demo/examples', {"name": $scope.test}).then(
                                                    function (res) {
                                                        model[key] = model[key] || {};
